...
\begin{itemize}
  %\item{Built JSON configurable multi-threaded database PII masking application in Haskell for MySQL and MongoDB}
...
\ressubheading{Tulip Retail}{September 2018 - December 2018}{Full-stack Software Developer Co-op}{Kitchener, ON}
\begin{itemize}
...
\ressubheading{Grapevine6}{January 2018 - April 2018}{Full-stack Software Developer Co-op}{Toronto, ON}
\begin{itemize}
...
\section{Projects}
\resprojheading{git-haskell}{Haskell}
\begin{itemize}
...
\section{Education}
\ressubheading{University of Waterloo}{2016-Present}
